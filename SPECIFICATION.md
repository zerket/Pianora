...
| MIDI устройство подключено | Короткая белая вспышка                  |
| Ошибка                                   | Красная вспышка                               |

### 1.3 Первый запуск — обязательная калибровка
...
### 2.7 Режим игры/развлечения (Game)
...
### 2.9 Режим Synthesia (внешнее ПО)
...
### 2.10 Режим Falling Notes (Падающие ноты)
