...
export const es: TranslationKeys = {
  ...
  'help.hotkeys.randomMode': 'Modo Aleatorio (colores aleatorios)',
  'help.hotkeys.velocityMode': 'Modo Velocidad (color por presión)',
  'help.hotkeys.rainbowMode': 'Modo Arcoíris (gradiente en teclado)',
