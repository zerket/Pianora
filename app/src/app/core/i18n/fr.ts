...
export const fr: TranslationKeys = {
  ...
  'help.hotkeys.randomMode': 'Mode Aléatoire (couleurs aléatoires)',
  'help.hotkeys.velocityMode': 'Mode Vélocité (couleur par pression)',
  'help.hotkeys.rainbowMode': 'Mode Arc-en-ciel (dégradé sur clavier)',
