...
export const ru: TranslationKeys = {
  ...
  'help.hotkeys.randomMode': 'Random Mode (случайные цвета)',
  'help.hotkeys.velocityMode': 'Velocity Mode (цвет по силе нажатия)',
  'help.hotkeys.rainbowMode': 'Rainbow Mode (радуга по клавиатуре)',
